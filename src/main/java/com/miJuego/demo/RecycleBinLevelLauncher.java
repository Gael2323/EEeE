...
/**
 * Lanza el nivel 2 (Papelera de Reciclaje) desde el Hub.
 */
public final class RecycleBinLevelLauncher {

    public static void launch() {
        SwingUtilities.invokeLater(() -> {
            // Fondo personalizado de la papelera
            BackgroundSettings bg = BackgroundSettings.getInstance();
            bg.setImagePath("assets/recycle_bin/recycle_bin_bg.png");
            bg.setFallbackColor(new java.awt.Color(10, 10, 20)); // oscuro por si falla la imagen
            ...
            TowerDefenseModel model = new TowerDefenseModel(view, 2);
            ...
            GameModel wrappedModel = new com.miJuego.sandbox.DevConsoleModelWrapper(model, console);
    ...
    private RecycleBinLevelLauncher() {}
}
