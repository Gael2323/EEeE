...
/**
 * Lanza el nivel 99 (Prueba) desde la demo.
 */
public final class TestLevelLauncher {
    ...
    public static void launch() {
        SwingUtilities.invokeLater(() -> {
            ...
            bg.setFallbackColor(new java.awt.Color(255, 255, 255)); // blanco puro

            GameView view = GameViews.getInstance().getView();
            GameViewMessages.getInstance().bind(view);

            // Iniciar Nivel 99 con límites de 64x48
            com.miJuego.model.CameraContext.setWorldBounds(64f, 48f);
            TowerDefenseModel model = new TowerDefenseModel(view, 99);
